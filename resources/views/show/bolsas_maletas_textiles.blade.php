...
@section('articulo')
	...
	<div class="jumbotron text-center" style="background-color: white;padding-top: 40px;padding-bottom: 40px;margin-bottom: 0px;">
	  	...
	  	<div class="col-md-12 zoom">
			...
			@else
				<center><img src="{{ asset('img/'.$articulo->categoria.'/'.$articulo->catalogo.'/'.$articulo->modelo.'/'.$articulo->modelo.'_'.$articulo->color.'.jpg') }}" alt="Card image" style="height: 300px;display: block;" class="zoom" id="imagen" /></center>
			@endif
		</div>
		<br><br>
