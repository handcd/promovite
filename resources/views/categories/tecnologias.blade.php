        ...
        @foreach ($tecnologia as $informacion)          
          <div class="col-sm-3 col-sm-6">                                                
            <div class="card mb-3">
              ...
              <img src="{{ asset('img/TECNOLOGÍA/'.$informacion->modelo.'/'.$informacion->modelo.'_'.$informacion->color.'_lrg.jpg') }}" alt="Imagen no disponible" style="height: 200px; width: 100%; display: block;" />
              <footer>
